                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <?php if( FunctionHTML::checkLogin(false) ){ ?>
                                <li><a href="/profile"><i class="fa fa-user"></i> <?php echo FunctionHTML::getUserName(); ?></a></li>
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="http://www.hcodecommerce.com.br/"><img src="/res/site/img/logo.png"></a></h1>
                    </div>
                </div>
                
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="/cart">Carrinho - <span class="cart-amunt">R$<?php echo FunctionHTML::getCartVlSubTotal(); ?></span> <i class="fa fa-shopping-cart"></i> <span class="product-count"><?php echo FunctionHTML::getCartNrQtd(); ?></span></a>
                    </div>
                </div>
            </div>
        </div>
