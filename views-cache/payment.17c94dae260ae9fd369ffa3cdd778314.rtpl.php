    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <button type="submit" id="btn-voltar" class="button alt" style="margin-bottom:10px">Voltar</button>
                ...
                document.querySelector("#btn-voltar").addEventListener("click", function(event){
                event.preventDefault();
