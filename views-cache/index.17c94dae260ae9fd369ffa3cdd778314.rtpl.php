...
<div class="slider-area">
    ...
    <div class="block-slider block-slider4">
        <ul class="" id="bxslider-home4">
            ...
            <li>
                <img src="<?php echo htmlspecialchars( $value1["desphoto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" alt="Slide" style="width: 500px; margin-left: 150px;">
                <div class="caption-group">
                    <h2 class="caption title">
                        <?php echo htmlspecialchars( $value1["desproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
                    </h2>
                    <h4 class="caption subtitle"><?php echo htmlspecialchars( $value1["desproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?></h4>
                ...
                <div class="product-carousel">
                    ...
                    <div class="single-product">
                        ...
                        <div class="product-carousel-price">
                            <ins>R$<?php echo FunctionHTML::formatPrice($value1["vlprice"]); ?></ins>
                        </div> 
                    </div>
                    <?php } ?>
                </div>
